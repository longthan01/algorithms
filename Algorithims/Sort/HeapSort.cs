namespace Algorithms.Sort
{
    ...
    /// </summary>
    public class HeapSort<T> : SortBase<T>, Sort.ISort<T>
    {
        ...
        private void BuildMaxHeap(int i, int subArrayLength)
        {
            ...
            if (leftChildIndex < subArrayLength && this.LessThan(Array[maxIndex], Array[leftChildIndex]))
            {
                maxIndex = leftChildIndex;
            }
            if (rightChildIndex < subArrayLength && this.LessThan(Array[maxIndex], Array[rightChildIndex]))
            {
